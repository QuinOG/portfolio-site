...
const About = () => {
  ...
  const bios = [
    ...
    "I'm currently pursuing an A.S. degree in IT Security. My journey in IT began two years ago, during which I've gained experience working on various projects, from configuring networks to building complex web applications. I'm committed to continuous learning to keep up with the rapidly evolving field of web development.",
    "I'm currently pursuing my A.S. degree in IT Security - specializing in Infrastructure - at Santa Fe College in my hometown of Gainesville, Florida. After graduating, I plan to transfer to UF to obtain a B.S. in Computer Science. My journey in IT began two years ago, and since then, I've had the opportunity to work on various projects, ranging from network setups to advanced web applications. I'm dedicated to continually learning and exploring emerging technologies to stay ahead in the dynamic field of web development."
  ];
      ...
      <div className="container about-container">
        <div className="about-content">
          <div className="about-header">
            <div className="about-title-bio-container">
